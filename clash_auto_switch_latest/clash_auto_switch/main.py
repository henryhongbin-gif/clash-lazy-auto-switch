...
def parse_args(config: Config) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=None,
        help="prefer quick recovery during failure scans",
    )
    parser.add_argument(
        "--scan-workers",
        type=int,
        default=None,
        help="override CLASH_SCAN_WORKERS",
    )
    parser.add_argument(
    ...
    parser.add_argument("--once", action="store_true", default=None, help="run once and exit")
    parser.add_argument(
        "--force-scan",
        action="store_true",
        default=None,
